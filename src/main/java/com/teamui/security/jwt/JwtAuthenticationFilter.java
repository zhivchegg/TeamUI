...
/**
 * Extracts and validates JWT from the {@code Authorization} header on every request.
 *
 * <p>If the token is valid, sets the authenticated user into the Spring Security context.</p>
 *
 * @author TeamUI
 * @since 0.0.1
 */
